...
enum ItemType {
  ...
  List<String> get columns => this == device
      ? ["Fabricante", "Modelo", "Plataforma"]
      : this == computer
          ? ["Plataforma", "Sistema Operacional", "Tipo"]
          : this == app
              ? ["Nome", "Versão", "Autor"]
              : [];

  List<String> get properties => this == device
...
class DataService {
  ...
  void carregar(index) {
    final params = [ItemType.device, ItemType.computer, ItemType.app];
